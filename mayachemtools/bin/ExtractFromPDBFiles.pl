#!/usr/bin/perl -w
#
# $RCSfile: ExtractFromPDBFiles.pl,v $
# $Date: 2017/01/12 18:57:06 $
# $Revision: 1.41 $
#
...
sub ExtractChains {
  ...
  my($ChainIndex, $ChainID, $ChainLabel, $PDBFileName, $RecordLine, $ChainsAndResiduesInfoRef, $AtomNumber, $AtomName, $ResidueName, $AtomChainID, $ResidueNumber, $AlternateLocation, $InsertionCode, $ConectRecordLinesRef, %ChainAtomNumbersMap);

  # Get chains and residues data...
  $ChainsAndResiduesInfoRef = GetChainsAndResidues($PDBRecordLinesRef, 'AtomAndHetatm', 0, 1);
...
"AtomName, [AtomName...]"] [B<-c, --chains> First | All | "ChainID, [ChainID,...]"]
...
This option is ignored during I<Chains, Sequences> values of B<-m, --mode> option.
