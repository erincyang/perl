...
//
// msud@san.rr.com: July 8, 2011
//
// The following If statement block doesn't appear to work in IE 8.0 on Windows XP and
// has been replaced by "if...else if..." statements.
//
...
// known exceptions (old browsers):
  ...
  if (browser == "opera") {
    if (browserVersion <= 7.54 && os == "mac") {
      isBrowserCompliant = false;
    }
  }
  else if (browser == "webkit") {
    if (browserVersion < 125.12) {
      isBrowserCompliant = false;
    }
  }
